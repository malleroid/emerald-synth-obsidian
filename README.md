...
3. Search for "Emerald Synth" and install

### Manual

1. Download `theme.css` and `manifest.json` from the [latest release](https://github.com/malleroid/emerald-synth-obsidian/releases/latest)
2. Create a folder `emerald-synth` under your vault's `.obsidian/themes/` directory
3. Place `theme.css` and `manifest.json` into that folder
4. Settings -> Appearance -> Themes -> Select "Emerald Synth"
